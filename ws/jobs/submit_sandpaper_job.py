...
if __name__ == '__main__':
    ...
    property_dict["INPUT"] = "/user/worker/cdr3/domain5/etk_out/domain5/13"
    property_dict["OUTPUT"] = "/user/worker/cdr3/domain5/sandpaper_out/domain5/13"
    property_dict["INDEX"] = "domain5_deployed"
